...
<div class="box-body">
    <form class="form-sample" action="{{route('testimonial.update',$testimonial->id)}}" method="POST"
        ...
        {{ csrf_field() }}
        <div class="st-set">
            <div class="st-set-title">Update Testimonial 
            </div>
            <div class="st-body">
                {{-- <div class="row"> --}}
                    <div class="col-md">
                        <div class="form-group">
                            ...
                            <input type="text" id="mytextarea" class="form-control" name="description" placeholder="Enter description" value="{{$testimonial->testimonial}}"/>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div class="form-group">
                            <label for="name" class="font-weight-bold"> Title </label>
                            <input type="text" name="name" class="form-control" placeholder="Enter Title" value="{{$testimonial->clients_name}}"/>
                        </div>
                    </div>                    
                {{-- </div> --}}
                {{-- <div class="row"> --}}
                    ...
                    <img src="{{url('/storage/'.$testimonial->image)}}" style="width: 80px;">
